...
async function seed() {
  ...
  // 2. Inventory Table (Updated with Category & Location)
  await client.execute("DROP TABLE IF EXISTS stock_logs")
  await client.execute("DROP TABLE IF EXISTS inventory")
  ...
  await client.executeMultiple(`
    INSERT INTO inventory (id, material_name, category, location, stock, min_stock, unit, updated_at) VALUES 
    ('MAT-001', 'HDPE Granule', 'Bahan Baku', 'Gudang A-1', 2400, 1000, 'kg', '2024-05-08'),
    ('MAT-002', 'LDPE Granule', 'Bahan Baku', 'Gudang A-2', 1398, 1000, 'kg', '2024-05-08'),
    ('MAT-003', 'PP Granule', 'Bahan Baku', 'Gudang A-3', 800, 1000, 'kg', '2024-05-08'),
    ('MAT-004', 'PVC Compound', 'Bahan Baku', 'Gudang B-1', 3908, 1500, 'kg', '2024-05-08'),
    ('MAT-005', 'PET Resin', 'Bahan Baku', 'Gudang B-2', 4800, 2000, 'kg', '2024-05-08'),
    ('MAT-006', 'Pewarna Merah', 'Aditif', 'Gudang C-1', 45, 50, 'kg', '2024-05-08'),
    ('MAT-007', 'Pewarna Biru', 'Aditif', 'Gudang C-2', 120, 50, 'kg', '2024-05-08');
  `)
  console.log("✅ Inventory table updated & seeded!")
